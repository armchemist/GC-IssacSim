#!/usr/bin/env bash
# Import omx_f_on_rail.urdf → model/omx_f_rail.usd and stream via WebRTC.
# Run this ONCE to generate the USD; then use run_teleop_omx_rail.sh for teleop.
set -e
...
exec python "$PROJECT_DIR/load_omx_f_rail.py" \
